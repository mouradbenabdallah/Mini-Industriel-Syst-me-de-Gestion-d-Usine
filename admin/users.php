...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="user_add.php" class="btn btn-dark"><i class="bi bi-person-plus"></i> Ajouter</a>
</div>
    ...
    <div class="table-responsive">
        <table class="table table-hover mb-0">
            <thead class="table-dark">
                <tr><th>ID</th><th>Nom</th><th>Email</th><th>Rôle</th><th>Statut</th><th>Inscrit le</th><th>Actions</th></tr>
            </thead>
            <tbody>
