...
// Pour les clients: peuvent envoyer aux admin/manager
// Pour les managers: peuvent envoyer à tous
if ($role === 'client') {
    $stmt = $pdo->prepare("SELECT id, nom, role FROM users WHERE id != ? AND actif = 1 AND role IN ('admin','manager') ORDER BY nom");
} else {
...
$page_title = 'Messages - Ventes';
$module_color = 'danger';
require_once '../includes/header.php';
?>

<h2 class="mb-4"><i class="bi bi-envelope"></i> Messages Ventes</h2>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="post" action="../messages_process.php">
                    <input type="hidden" name="redirect" value="ventes/messages.php">
                    <div class="mb-3">
