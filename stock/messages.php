    ...
    <div class="col-md-8">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active" id="inbox">
                <?php if (!$inbox): ?><p class="text-muted">Aucun message reçu.</p><?php endif; ?>
